  ...
  try {
    ...
    try {
      if (Array.isArray(snapshot.students) && snapshot.students.length > 0) {
        ...
        if (!currentCount || parseInt(currentCount.count, 10) === 0) {
    ...
    try {
      if (Array.isArray(snapshot.programs) && snapshot.programs.length > 0) {
        ...
        if (!currentCount || parseInt(currentCount.count, 10) === 0 || parseInt(currentCount.count, 10) < snapshot.programs.length) {
    ...
    try {
      if (Array.isArray(snapshot.program_participants) && snapshot.program_participants.length > 0) {
        ...
        if (!currentCount || parseInt(currentCount.count, 10) === 0 || parseInt(currentCount.count, 10) < snapshot.program_participants.length) {
