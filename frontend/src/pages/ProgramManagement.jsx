...
export default function ProgramManagement() {
  ...
  return (
    <div className="space-y-6" onClick={() => setActiveDropdown(null)}>
      ...
      {showWinnersModal && targetProgramForWinners && (
        <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center bg-slate-900/60 backdrop-blur-md p-3 sm:p-6 overflow-y-auto">
          <div 
            ...
            className="glass-panel p-6 sm:p-8 rounded-3xl border border-slate-200 max-w-4xl w-full bg-white text-slate-900 shadow-2xl space-y-6 my-4 sm:my-auto"
          >
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center bg-slate-900/60 backdrop-blur-md p-3 sm:p-6 overflow-y-auto">
          <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-slate-200 max-w-4xl w-full bg-white text-slate-900 shadow-2xl space-y-5 my-4 sm:my-auto">
