  ...
  if (isStudent) {
    ...
    return (
      <div className="max-w-xl mx-auto space-y-6">
        <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-slate-200 bg-white text-slate-900 shadow-sm">
          ...
          {savedSuccess && (
            <div className="p-3 mb-4 rounded-xl bg-emerald-50 text-emerald-800 border border-emerald-300 text-xs font-bold flex items-center space-x-2">
          ...
          <form onSubmit={handleSave} className="space-y-4 text-xs">
            <div>
              <label className="block text-slate-700 font-bold mb-1">Code No</label>
              <input
                type="text"
                required
                ...
                className="w-full bg-slate-50 border border-slate-300 rounded-xl p-3 text-slate-900 font-bold font-mono focus:border-emerald-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              <label className="block text-slate-700 font-bold mb-1">House Selection</label>
              <select
            ...
            <div className="flex justify-end pt-4 border-t border-slate-200">
              <button
                type="submit"
                className="flex items-center space-x-2 px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-xs shadow-md transition"
              >
